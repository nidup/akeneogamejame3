...
export default class Menu extends Phaser.State {
    ...
    public create ()
    {
        ...
        this.briefingTextLine1 = this.game.add.bitmapText(40, 270, 'carrier-command','As the king of gnomes, your plan is,', 15);
        this.briefingTextLine2 = this.game.add.bitmapText(40, 300, 'carrier-command','A) Steal underpants\n\nB) ? \n\nC) Profit', 15);

        this.startText = this.game.add.bitmapText(240, 410, 'carrier-command','Press Enter to start', 10);

        this.coin1 = this.game.add.sprite(200, 407, 'coin', 0);
        this.coin1.animations.add('flip', [0, 1, 2, 3, 4, 5, 6, 7], 10, true);
        this.coin1.play('flip');

        this.coin2 = this.game.add.sprite(500, 407, 'coin', 0);
